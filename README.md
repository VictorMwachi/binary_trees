...
CGroup projectAlgorithmData structure
    ...
    Project over - took place from Sep 19, 2022 6:00 AM to Sep 23, 2022 6:00 AM
    An auto review will be launched at the deadline

In a nutshell…

    Contribution: 100.0%
    Auto QA review: 34.5/157 mandatory & 0.0/196 optional
    Altogether:  21.97%
        Mandatory: 21.97%
        Optional: 0.0%
        Contribution: 100.0%
        Calculation:  100.0% * (21.97% + (21.97% * 0.0%) )  == 21.97%
